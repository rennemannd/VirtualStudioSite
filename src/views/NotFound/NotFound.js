    ...
    render() {
        return (
            ...
            <div className="denied__wrapper">
                <h1>404</h1>
                <h3>LOST IN <span>ORBIT</span> Virtual Studio? The page you were looking for does not exist.</h3>
                ...
                <div style={{"text-align": "center"}}>
                    <NavLink to={"/"}><a className="button">Go Home</a></NavLink>
                </div>
            </div>
            </html>
        )
